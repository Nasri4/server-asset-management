-- ============================================================
-- SEED ROLES & PERMISSIONS ONLY - No predefined users
-- Use this if you want to create all users via API (e.g. Postman bootstrap).
...
-- No users inserted. Create the first user via API: POST /api/auth/bootstrap (see docs/API_POSTMAN.md)
